...
const stub_url = process.env.STUB_URL || "https://orchstub-authdev1.signin.dev.account.gov.uk";
...
app.get("/", async (req, res) => {
  // call orch stub
  const orchStubResponse = await axios.post(stub_url, "reauthenticate=&level=Cl.Cm&authenticated=no&authenticatedLevel=Cl.Cm&channel=none", {
