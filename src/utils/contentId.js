...
import { isReauth, isUpliftRequired, isAccountRecoveryJourney, isAccountRecoveryJourneyAndEnabled, isContactUsSuggestionsFeedbackSubtheme, clientIsOneLogin, clientUsesOneLoginOptionally, supportTypeIsGovService, urlContains, } from "./request";
const CONTENT_IDS = {
    [PATH_NAMES.ACCESSIBILITY_STATEMENT]: () => "",
    [PATH_NAMES.ACCOUNT_NOT_FOUND]: (req) => clientIsOneLogin(req) || clientUsesOneLoginOptionally(req)
    ...
    [PATH_NAMES.CANNOT_CHANGE_SECURITY_CODES_IDENTITY_FAIL]: () => "d1b7cd24-f508-49ce-bf0d-ac1fe980c09c",
    [PATH_NAMES.CHANGE_SECURITY_CODES_CONFIRMATION]: () => "1abedb1b-7d09-4e81-9f88-a8b4297635b3",
    [PATH_NAMES.CHECK_YOUR_EMAIL]: () => "054e1ea8-97a8-461a-a964-07345c80098e",
    [PATH_NAMES.CHECK_YOUR_EMAIL_CHANGE_SECURITY_CODES]: (req) => isAccountRecoveryJourney(req)
    ...
    [PATH_NAMES.CREATE_ACCOUNT_ENTER_PHONE_NUMBER]: (req) => isAccountRecoveryJourneyAndEnabled(req)
        ? "cbca1676-f632-4937-984e-1ae5934d13e2"
        : "0f519eb6-5cd4-476f-968f-d847b3c4c034",
    [PATH_NAMES.CREATE_ACCOUNT_SETUP_AUTHENTICATOR_APP]: (req) => isAccountRecoveryJourney(req)
        ? "124051ef-673a-4eda-b585-96d9d711f545"
        : "5bc82db9-2012-44bf-9a7d-34d1d22fb035",
    [PATH_NAMES.CONTACT_US]: (req) => supportTypeIsGovService(req) ? "" : "e08d04e6-b24f-4bad-9955-1eb860771747",
    [PATH_NAMES.CONTACT_US_FURTHER_INFORMATION]: () => "a06d6387-d411-47db-8f7d-88871286330b",
    [PATH_NAMES.CONTACT_US_QUESTIONS]: (req) => isContactUsSuggestionsFeedbackSubtheme(req)
    ...
    [PATH_NAMES.ENTER_AUTHENTICATOR_APP_CODE]: (req) => {
        if (isReauth(req)) {
    ...
    [PATH_NAMES.ENTER_PASSWORD]: (req) => isReauth(req)
        ? "c6f4fed1-ee6d-4d23-a14f-4466e9c1349c"
        : "6b9f2243-d217-4c55-8ef3-7ac24b1f77e2",
    [PATH_NAMES.GET_SECURITY_CODES]: (req) => isAccountRecoveryJourney(req)
        ? "e768e27b-1c4d-48ba-8bcf-4c40274a6441"
        : "95e26313-bc2f-49bc-bc62-fd715476c1d9",
    ...
    [PATH_NAMES.RESEND_MFA_CODE]: (req) => isReauth(req)
        ? "a2776ef7-9ef3-4d8d-bdbc-3f798b15e5d4"
        : "f463a280-31f1-43c0-a2f5-6b46b1e2bb15",
    [PATH_NAMES.RESEND_MFA_CODE_ACCOUNT_CREATION]: () => "8247477c-3e33-4dae-9528-22e7ed44efb3",
    ...
    [PATH_NAMES.RESET_PASSWORD_CHECK_EMAIL]: (req) => {
    ...
    [PATH_NAMES.SECURITY_CODE_REQUEST_EXCEEDED]: () => "445409a8-2aaf-47fc-82a9-b277eca4601d",
...
export function getContentId(req, contentIds = CONTENT_IDS) {
