    ...
    const testCases = [
      {
        conditions: {
          ...
          accountInterventionAppliedDuringPasskeyRegistration: false,
        },
        expected: true,
      },
      {
        ...
        const req = {
          session: {
            user: {
              ...
              accountInterventionAppliedDuringPasskeyRegistration:
                conditions.accountInterventionAppliedDuringPasskeyRegistration,
