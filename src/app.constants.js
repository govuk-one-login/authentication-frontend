export var MFA_METHOD_TYPE;
(function (MFA_METHOD_TYPE) {
    MFA_METHOD_TYPE["SMS"] = "SMS";
    MFA_METHOD_TYPE["AUTH_APP"] = "AUTH_APP";
})(MFA_METHOD_TYPE || (MFA_METHOD_TYPE = {}));
export const PATH_NAMES = {
    ...
    CANNOT_CHANGE_SECURITY_CODES_IDENTITY_FAIL: "/cannot-change-security-codes-identity-fail",
...
export const ERROR_MESSAGES = {
    ...
    INVALID_SESSION_GOV_UK_INTERNAL_REQUEST: "Invalid session and referrer has gov.uk domain",
    INVALID_SESSION_NON_GOV_UK_EXTERNAL_REQUEST: "Invalid session and referrer does not have gov.uk domain",
...
export const CONTACT_US_THEMES = {
    ...
    PROVING_IDENTITY_FACE_TO_FACE_PROBLEM_FINDING_RESULT: "face_to_face_post_office_id_results",
    ...
    PROVING_IDENTITY_PROBLEM_ANSWERING_SECURITY_QUESTIONS: "proving_identity_problem_answering_security_questions",
    PROVING_IDENTITY_PROBLEM_WITH_IDENTITY_DOCUMENT: "proving_identity_problem_with_identity_document",
    PROVING_IDENTITY_PROBLEM_WITH_BANK_BUILDING_SOCIETY_DETAILS: "proving_identity_problem_with_bank_building_society_details",
    PROVING_IDENTITY_NEED_TO_UPDATE_PERSONAL_INFORMATION: "proving_identity_need_to_update_personal_information",
    PROVING_IDENTITY_SOMETHING_ELSE: "proving_identity_something_else",
    PROVING_IDENTITY_PROBLEM_WITH_NATIONAL_INSURANCE_NUMBER: "proving_identity_problem_with_national_insurance_number",
...
(function (NOTIFICATION_TYPE) {
    NOTIFICATION_TYPE["VERIFY_EMAIL"] = "VERIFY_EMAIL";
    NOTIFICATION_TYPE["VERIFY_PHONE_NUMBER"] = "VERIFY_PHONE_NUMBER";
    NOTIFICATION_TYPE["ACCOUNT_CREATED_CONFIRMATION"] = "ACCOUNT_CREATED_CONFIRMATION";
    NOTIFICATION_TYPE["MFA_SMS"] = "MFA_SMS";
    NOTIFICATION_TYPE["RESET_PASSWORD_WITH_CODE"] = "RESET_PASSWORD_WITH_CODE";
    NOTIFICATION_TYPE["VERIFY_CHANGE_HOW_GET_SECURITY_CODES"] = "VERIFY_CHANGE_HOW_GET_SECURITY_CODES";
    NOTIFICATION_TYPE["CHANGE_HOW_GET_SECURITY_CODES_CONFIRMATION"] = "CHANGE_HOW_GET_SECURITY_CODES_CONFIRMATION";
...
export var SUPPORT_TYPE;
(function (SUPPORT_TYPE) {
    SUPPORT_TYPE["GOV_SERVICE"] = "GOV_SERVICE";
    SUPPORT_TYPE["PUBLIC"] = "PUBLIC";
})(SUPPORT_TYPE || (SUPPORT_TYPE = {}));
export var JOURNEY_TYPE;
(function (JOURNEY_TYPE) {
    JOURNEY_TYPE["REGISTRATION"] = "REGISTRATION";
    JOURNEY_TYPE["ACCOUNT_RECOVERY"] = "ACCOUNT_RECOVERY";
    JOURNEY_TYPE["SIGN_IN"] = "SIGN_IN";
    JOURNEY_TYPE["PASSWORD_RESET_MFA"] = "PASSWORD_RESET_MFA";
    JOURNEY_TYPE["REAUTHENTICATION"] = "REAUTHENTICATION";
})(JOURNEY_TYPE || (JOURNEY_TYPE = {}));
export var CHANNEL;
(function (CHANNEL) {
    CHANNEL["WEB"] = "web";
    CHANNEL["STRATEGIC_APP"] = "strategic_app";
})(CHANNEL || (CHANNEL = {}));
...
export const WEB_TO_MOBILE_TEMPLATE_MAPPINGS = {
...
export const WEB_TO_MOBILE_ERROR_MESSAGE_MAPPINGS = {
    "pages.reEnterEmailAccount.enterYourEmailAddressError": "mobileAppPages.reEnterEmailAccount.enterYourEmailAddressError",
};
