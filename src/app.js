...
import { getAppEnv, getLanguageToggleEnabled, getNodeEnv, getSessionExpiry, getSessionSecret, supportAccountInterventions, supportAccountRecovery, supportAuthorizeController, supportMfaResetWithIpv, } from "./config";
...
async function createApp() {
    ...
    app.use("/assets", express.static(path.resolve("node_modules/govuk-frontend/govuk/assets"), staticAssetOptions));
    ...
    await i18next
        ...
        .init(i18nextConfigurationOptions(path.join(__dirname, "locales/{{lng}}/{{ns}}.json")));
    ...
    app.use(session({
        ...
        unset: "destroy",
        resave: false,
        cookie: getSessionCookieOptions(isProduction, getSessionExpiry(), getSessionSecret()),
