...
describe("Integration::how do you want security codes", () => {
  ...
  const BACKUP_AUTH_APP_ID = "9b27c3d4-f5a1-42e3-8c1d-a4b678e90f2d";
  ...
  it("should return how do you want security codes page as expected for user with two SMS MFAs", async () => {
  ...
  it("should return how do you want security codes page as expected for user SMS and AUTH APP", async () => {
    const { createApp } = await esmock(
      "../../../app.js",
      {},
      {
