...
import xss from "xss";
import { CONTACT_US_FIELD_MAX_LENGTH, CONTACT_US_THEMES, CONTACT_US_COUNTRY_MAX_LENGTH, } from "../../app.constants";
import { internationalPhoneNumberMustBeValid, ukPhoneNumberMustContainLeadingPlusNumbersOrSpacesOnly, ukPhoneNumberMustBeValid, ukPhoneNumberMustHaveLengthWithoutSpacesInRange, internationalPhoneNumberMustContainLeadingPlusNumbersOrSpacesOnly, internationalPhoneNumberMustHaveLengthWithoutSpacesInRange, } from "../common/phone-number/phone-number-validation";
const sanitizeFreeTextValue = function sanitizeFreeTextValue(value) {
    return xss(value);
};
export function validateContactUsQuestionsRequest() {
    return [
        body("location").custom((value, { req }) => {
            if (req.body.subtheme ===
                CONTACT_US_THEMES.PROVING_IDENTITY_PROBLEM_WITH_ADDRESS &&
                value === undefined) {
                throw new Error(req.t("pages.contactUsQuestions.provingIdentityProblemEnteringAddress.location.errorMessage", {
                    value,
                    lng: req.i18n.lng,
                }));
            }
        ...
        body("securityCodeSentMethod")
            ...
            return req.t("pages.contactUsQuestions." +
                req.body.formType +
        ...
        body("identityDocumentUsed")
            ...
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.takingPhotoOfIdProblem.identityDocument.errorMessage", { value, lng: req.i18n.lng });
        }),
        body("identityDocumentUsed")
            ...
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.provingIdentityProblemWithIdentityDocument.identityDocument.errorMessage", { value, lng: req.i18n.lng });
        }),
        body("problemWith")
            .if(body("theme").equals("proving_identity"))
            .if(body("subtheme").equals("proving_identity_problem_with_bank_building_society_details"))
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.provingIdentityProblemWithBankBuildingSocietyDetails.section1.errorMessage", { value, lng: req.i18n.lng });
        }),
        body("issueDescription")
            .optional()
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t(getErrorMessageForIssueDescription(req.body.theme, req.body.subtheme), { value, lng: req.i18n.lng });
        }),
        body("issueDescription")
        ...
        body("issueDescription")
            ...
            .withMessage((value, { req }) => {
            return req.t(getLengthExceededErrorMessageForIssueDescription(req.body.theme, req.body.subtheme), { value, lng: req.i18n.lng });
        }),
        body("additionalDescription")
            .optional()
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t(getErrorMessageForAdditionalDescription(req.body.theme, req.body.subtheme), { value, lng: req.i18n.lng });
        }),
        body("additionalDescription")
            .optional()
            .isLength({ max: CONTACT_US_FIELD_MAX_LENGTH })
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.additionalDescriptionErrorMessage.entryTooLongMessage", { value, lng: req.i18n.lng });
        }),
        body("optionalDescription")
            .optional()
            .isLength({ max: CONTACT_US_FIELD_MAX_LENGTH })
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.optionalDescriptionErrorMessage.entryTooLongMessage", { value, lng: req.i18n.lng });
        }),
        body("moreDetailDescription")
            .optional()
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.optionalDescriptionErrorMessage.message", { value, lng: req.i18n.lng });
        }),
        body("serviceTryingToUse")
            .optional()
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.serviceTryingToUse.errorMessage", { value, lng: req.i18n.lng });
        }),
        body("moreDetailDescription")
            .optional()
            .isLength({ max: CONTACT_US_FIELD_MAX_LENGTH })
        ...
        body("problemWithNationalInsuranceNumber")
            .if(body("theme").equals("proving_identity"))
            .if(body("subtheme").equals("proving_identity_problem_with_national_insurance_number"))
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.provingIdentityProblemWithNationalInsuranceNumber.section1.errorMessage", { value, lng: req.i18n.lng });
        }),
        body("problemWithNationalInsuranceNumber")
            .if(body("theme").equals("proving_identity"))
            .if(body("subtheme").equals("proving_identity_problem_with_national_insurance_number"))
        ...
        body("suspectUnauthorisedAccessReasons")
            ...
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.suspectUnauthorisedAccess.section2.validationError.selectAtLeastOne", { value, lng: req.i18n.lng });
        }),
        body("contact")
            .if(body("theme")
            .not()
            ...
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.replyByEmail.validationError.noBoxSelected", { value, lng: req.i18n.lng });
        }),
        body("email")
            .if(body("theme").equals(CONTACT_US_THEMES.SUSPECT_UNAUTHORISED_ACCESS))
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.suspectUnauthorisedAccess.section3.validationError.noEmailAddress", { value, lng: req.i18n.lng });
        })
            .isEmail()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.suspectUnauthorisedAccess.section3.validationError.invalidFormat", { value, lng: req.i18n.lng });
        }),
        body("email")
            .if(body("theme")
            .not()
            ...
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.replyByEmail.validationError.noEmailAddress", { value, lng: req.i18n.lng });
        })
            .isEmail()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.replyByEmail.validationError.invalidFormat", { value, lng: req.i18n.lng });
        }),
        body("phoneNumber")
            .if(body("theme").equals(CONTACT_US_THEMES.SUSPECT_UNAUTHORISED_ACCESS))
        ...
        body("country")
            .optional()
            .custom((value, { req }) => {
            if (req.body.securityCodeSentMethod ===
                "text_message_international_number") {
                if (!value) {
                    throw new Error(req.t("pages.contactUsQuestions.textMessageInternationNumberConditionalSection.errorIfBlank", {
                        value,
                        lng: req.i18n.lng,
                    }));
                }
        ...
        body("countryPhoneNumberFrom")
            ...
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.signInPhoneNumberIssue.section3.ifBlankErrorMessage", { value, lng: req.i18n.lng });
        }),
        body("countryPhoneNumberFrom")
            .optional()
            .isLength({ max: CONTACT_US_COUNTRY_MAX_LENGTH })
            .withMessage((value, { req }) => {
            return req.t("pages.contactUsQuestions.signInPhoneNumberIssue.section3.ifTooLongErrorMessage", { value, lng: req.i18n.lng });
        }),
...
export function getErrorMessageForIssueDescription(theme, subtheme) {
...
export function getErrorMessageForFaceToFaceIssueDescription(subtheme) {
    const errorMessagesForFaceToFaceIssueDescription = {
        [CONTACT_US_THEMES.PROVING_IDENTITY_FACE_TO_FACE_PROBLEM_ENTERING_DETAILS]: "pages.contactUsQuestions.provingIdentityFaceToFaceDetails.whatHappened.errorMessage",
        [CONTACT_US_THEMES.PROVING_IDENTITY_FACE_TO_FACE_PROBLEM_LETTER]: "pages.contactUsQuestions.provingIdentityFaceToFaceLetter.whatHappened.errorMessage",
        [CONTACT_US_THEMES.PROVING_IDENTITY_FACE_TO_FACE_PROBLEM_AT_POST_OFFICE]: "pages.contactUsQuestions.provingIdentityFaceToFacePostOffice.whatHappened.errorMessage",
        [CONTACT_US_THEMES.PROVING_IDENTITY_FACE_TO_FACE_PROBLEM_FINDING_RESULT]: "pages.contactUsQuestions.provingIdentityFaceToFaceIdResults.whatHappened.errorMessage",
        [CONTACT_US_THEMES.PROVING_IDENTITY_FACE_TO_FACE_PROBLEM_CONTINUING]: "pages.contactUsQuestions.provingIdentityFaceToFaceService.whatHappened.errorMessage",
        [CONTACT_US_THEMES.PROVING_IDENTITY_FACE_TO_FACE_TECHNICAL_PROBLEM]: "pages.contactUsQuestions.provingIdentityFaceToFaceTechnicalProblem.section1.errorMessage",
    };
    return errorMessagesForFaceToFaceIssueDescription[subtheme];
}
export function getErrorMessageForAccountCreationIssueDescription(subtheme) {
...
export function getErrorMessageForSigningInIssueDescription(subtheme) {
    if (subtheme === CONTACT_US_THEMES.SOMETHING_ELSE) {
        return "pages.contactUsQuestions.signignInProblem.section1.errorMessage";
    }
}
export function getErrorMessageForIdCheckAppIssueDescription(subtheme) {
...
export function getLengthExceededErrorMessageForIssueDescription(theme, subtheme) {
    if (theme === CONTACT_US_THEMES.ACCOUNT_CREATION) {
...
export function getLengthExceededErrorMessageForAccountCreationIssueDescription(subtheme) {
    if (subtheme === CONTACT_US_THEMES.AUTHENTICATOR_APP_PROBLEM) {
        return "pages.contactUsQuestions.issueDescriptionErrorMessage.entryTooLongMessage";
    }
    if (subtheme === CONTACT_US_THEMES.TECHNICAL_ERROR) {
...
export function getLengthExceededErrorMessageForIdCheckAppIssueDescription(subtheme) {
    if (subtheme === CONTACT_US_THEMES.LINKING_PROBLEM) {
...
export function getLengthExceededErrorMessageForSigningInIssueDescription(subtheme) {
    if (subtheme === CONTACT_US_THEMES.ACCOUNT_NOT_FOUND) {
...
export function getErrorMessageForAdditionalDescription(theme, subtheme) {
    if (theme === CONTACT_US_THEMES.SOMETHING_ELSE) {
