...
export function validateSmsCodeRequest() {
    return [
        validateCode({
...
const postValidationLocals = function locals() {
    const resendCodeLinkAsPostValidationLocal = pathWithQueryParam(PATH_NAMES.RESEND_MFA_CODE_ACCOUNT_CREATION, "isResendCodeRequest", "true");
    return {
