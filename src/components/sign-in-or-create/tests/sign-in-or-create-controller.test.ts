...
describe("sign in or create controller", () => {
  ...
  describe("signInOrCreateGet", () => {
    ...
    it("should render the generic app template when the channel is generic app", async () => {
      res.locals.genericAppChannel = true;
    ...
    it("should render the strategic app template when the channel is strategic app", async () => {
