import { NOTIFICATION_TYPE, PATH_NAMES, MFA_METHOD_TYPE, } from "../../app.constants";
import { codeService } from "../common/verify-code/verify-code-service";
import { verifyCodePost } from "../common/verify-code/verify-code-controller";
import { ERROR_CODES, pathWithQueryParam, } from "../common/constants";
import { routeUsersToNewIpvJourney, supportAccountRecovery, supportMfaResetWithIpv, } from "../../config";
...
export const UPLIFT_REQUIRED_SMS_TEMPLATE_NAME = "enter-mfa/index-2fa-service-uplift-mobile-phone.njk";
export function enterMfaGet(acctRecoveryService = accountRecoveryService()) {
    return async function (req, res) {
        ...
        const mfaResetPath = routeUserViaIpvReset
            ...
            : pathWithQueryParam(PATH_NAMES.CHECK_YOUR_EMAIL_CHANGE_SECURITY_CODES, "type", MFA_METHOD_TYPE.SMS);
...
export const enterMfaPost = (service = codeService(), accountInterventionsService = accountInterventionService()) => {
    return async function (req, res) {
