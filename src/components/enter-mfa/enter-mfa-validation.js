...
import { ENTER_MFA_DEFAULT_TEMPLATE_NAME, UPLIFT_REQUIRED_SMS_TEMPLATE_NAME, } from "./enter-mfa-controller";
export function validateEnterMfaRequest() {
    return [
        validateCode({
        ...
        validateBodyMiddlewareUpliftTemplate(UPLIFT_REQUIRED_SMS_TEMPLATE_NAME, ENTER_MFA_DEFAULT_TEMPLATE_NAME),
    ];
}
