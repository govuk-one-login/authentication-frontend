...
export const TEST_SCENARIO_PARAMETERS_FOR_ACCOUNT_CREATION_JOURNEY = [
  {
...
export const TEST_SCENARIO_PARAMETERS_FOR_SECURITY_CODE_CANNOT_REQUEST_GET = [
  {
...
export const TEST_SCENARIO_PARAMETERS_FOR_SECUIRTY_CODE_EXPIRED_GET = [
  {
...
export const TEST_SCENARIO_PARAMETERS_FOR_SECURITY_CODE_TRIES_EXCEEDED_GET = [
  {
