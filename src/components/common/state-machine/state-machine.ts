...
const USER_JOURNEY_EVENTS = {
  ...
  REPROVE_IDENTITY_INTERVENTION: "REPROVE_IDENTITY_INTERVENTION",
  ...
  IPV_REVERIFICATION_FAILED_OR_DID_NOT_MATCH:
    "IPV_REVERIFICATION_FAILED_OR_DID_NOT_MATCH",
  MFA_RESET_ATTEMPTED_VIA_APP: "MFA_RESET_ATTEMPTED_VIA_APP",
  ...
  AMC_RETURNED_CREATE_PASSKEY_SKIPPED: "CREATE_PASSKEY_SKIPPED",
  AMC_RETURNED_CREATE_PASSKEY_BACK: "CREATE_PASSKEY_BACK",
  AMC_RETURNED_ACCOUNT_INTERVENTIONS: "AMC_RETURNED_ACCOUNT_INTERVENTIONS",
...
const authStateMachine = createMachine<AuthStateContext>(
  {
    ...
    states: {
      ...
      [PATH_NAMES.RESET_PASSWORD_2FA_SMS]: {
        ...
        meta: {
          optionalPaths: [PATH_NAMES.HOW_DO_YOU_WANT_SECURITY_CODES],
          permittedJourneyRouteEvents: [USER_JOURNEY_EVENTS.RESEND_SMS],
        },
      },
      [PATH_NAMES.RESET_PASSWORD_RESEND_CODE]: {
        on: {
      ...
      [PATH_NAMES.CREATE_PASSKEY_CALLBACK]: {
        on: {
          ...
          [USER_JOURNEY_EVENTS.AMC_RETURNED_CREATE_PASSKEY_SKIPPED]: [
            INTERMEDIATE_STATES.SIGN_IN_END,
          ],
          [USER_JOURNEY_EVENTS.AMC_RETURNED_CREATE_PASSKEY_BACK]: [
            PATH_NAMES.CREATE_PASSKEY,
          ],
