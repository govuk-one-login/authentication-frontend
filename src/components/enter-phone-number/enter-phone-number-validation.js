...
import { internationalPhoneNumberMustBeValid, internationalPhoneNumberMustContainLeadingPlusNumbersOrSpacesOnly, internationalPhoneNumberMustHaveLengthWithoutSpacesInRange, ukPhoneNumberMustBeValid, ukPhoneNumberMustContainLeadingPlusNumbersOrSpacesOnly, ukPhoneNumberMustHaveLengthWithoutSpacesInRange, } from "../common/phone-number/phone-number-validation";
export function validateEnterPhoneNumberRequest() {
    return [
        ...
        body("internationalPhoneNumber")
            ...
            .notEmpty()
            .withMessage((value, { req }) => {
            return req.t("sharedFields.phoneNumber.internationalPhoneNumber.validationError.required", { value });
        })
