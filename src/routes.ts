...
router.get(PATH_NAMES.ENTER_PASSWORD, csrfMiddleware, enterPasswordValidationSchema(), enterPasswordGet);
router.post(
...
router.get(PATH_NAMES.CREATE_ACCOUNT_SET_PASSWORD, csrfMiddleware, createAccountGet);
router.post(
