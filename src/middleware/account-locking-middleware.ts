...
import { getNewCodePath, isAuthApp } from "../components/security-code-error/security-code-error-controller";
...
export function accountLockingAccountRecoveryMiddleware(
  req: Request,
  res: Response,
  next: NextFunction
){
