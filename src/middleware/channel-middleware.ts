...
export function channelMiddleware(req: Request, res: Response, next: NextFunction): void {
...
function setChannelFlags(res: Response, channel?: string): void {
  ...
  res.locals.isApp = channel === CHANNEL.STRATEGIC_APP || channel === CHANNEL.GENERIC_APP;
}
